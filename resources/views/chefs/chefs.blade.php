...
@section('content')
<!-- CHEFS -->
<section id="chefs" style="padding-top: 120px;">
    <div class="container">
    ...
    <div class="row g-4">
        <div class="col-sm-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
            <div class="chcard">
                <div class="chimg">
                <img src="{{ asset('img/chefs/1.png') }}" alt=""/>
